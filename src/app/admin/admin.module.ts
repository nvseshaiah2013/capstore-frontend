...
@NgModule({
  declarations: [DashboardComponent, AdminHomeComponent, StatisticsComponent, OrdersComponent,ViewCustomersComponent, CategoryComponent, MinimumOrderValueComponent, AllMerchantComponent, InviteMerchantComponent, MerchantOrdersComponent, MerchantFeedbacksComponent, MerchantProductsComponent, AllFeedbacksComponent],
  imports: [
    CommonModule,
    AdminRoutingModule,
    FormsModule,
